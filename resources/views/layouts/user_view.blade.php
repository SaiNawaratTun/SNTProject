    ...
    <div class="container">
               <div class="row">
                            ...
                            <div class="collapse navbar-collapse" id="fablesNavDropdown"> 
                                ...
                                <ul class="navbar-nav mx-auto fables-nav">   
                                    <li class="nav-item dropdown">
                                        <a class="nav-link" href="/dashboard"  aria-haspopup="true" aria-expanded="false">
                                            Profile
                                        </a>
                                    </li>
                   ...
                   <div class="col-12 col-md-2 col-lg-3 pr-md-0 icons-header-mobile">
                         <a href="{{ route('profile.logout')}}" class="fables-third-text-color dropdown-toggle right px-3 px-md-2 px-lg-4 fables-second-hover-color top-header-link max-line-height position-relative">
                            <span class="fables-icon-sign-out"></span>
                            Log Out
                        </a>
