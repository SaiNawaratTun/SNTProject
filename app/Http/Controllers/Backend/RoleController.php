...
class RoleController extends Controller
{
   ...
   public function AddRolesPermission(){
    ...
    return view ('backend.pages.rolesetup.Add_role_permission', compact('roles','permissions','permission_group'));
   }//End Method
   ...
   public function StoreRolesPermission(Request $request){
    ...
    foreach($permissions as $key => $iteam){
        $data['role_id'] = $request->role_id;
        $data['permission_id'] = $iteam;
   ...
   public function EditRolesPermission($id){
    ...
    $permissions = Permission::all();
    $permission_group = User::getpermissionGroup();
    return view ('backend.pages.rolesetup.edit_role_permission', compact('role','permissions','permission_group'));
